...
const createEnumItemFromSub = async (ioBContext: I_IOBrokerConsumerType, parentID: string): Promise<I_EnumItem[]> => {
    const newMembers: I_EnumItem[] = [];
...
const createEnumChildCategoryWithId = async (ioBContext: I_IOBrokerConsumerType, id: string): Promise<I_Enum> => {
    const obj = await ObjectStateHelper.getObjectByID(ioBContext, id);
